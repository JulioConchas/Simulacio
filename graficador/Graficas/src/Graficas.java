...
public class Graficas {
	public Graficas(){
		...
		data.addValue(1052, ANNO1, "Años");
		data.addValue(1170, ANNO2, "Años");
		data.addValue(1186, ANNO3, "Años");
		data.addValue(1261, ANNO4, "Años");
		data.addValue(1295, ANNO5, "Años");
		data.addValue(1295, ANNO6, "Años");
		data.addValue(1295, ANNO7, "Años");
...
//		data.addValue(1295, "PIB", "2016");
		...
		JFreeChart grafica = ChartFactory.createBarChart3D("PIB mexico", "Años", "billones USD", data, PlotOrientation.VERTICAL, true, true,false);
